...
public class Spirit
{
    [SerializeField] SpiritBase _base;
    [SerializeField] int level;

    public Spirit(SpiritBase pBase, int pLevel)
    {
        _base = pBase;
        level = pLevel;
    ...
    public void Init()
    {
        ...
        foreach (var move in Base.LearnableMoves)
        {
            ...
            if (Moves.Count >= SpiritBase.MaxNumOfMoves)
                break;
        }
    ...
    public Spirit(SpiritSaveData saveData)
    {
        _base = SpiritDB.GetObjectByName(saveData.name);
        HP = saveData.hp;
    ...
    public SpiritSaveData GetSaveData()
    {
        var saveData = new SpiritSaveData()
        {
            name = Base.name,
            hp = HP,
            level = Level,
